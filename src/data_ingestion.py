    ...
    def divide_data_in_divisions(self):
        ...
        try:
            train_data, test_data = self.read_data(
                train_path=r"E:\Hackathon\UGAM\Participants_Data_DCW\processed_data\train_data_with_most_similar_words_processed_with_features.csv",
                test_path=r"E:\Hackathon\UGAM\Participants_Data_DCW\processed_data\test_data_with_most_similar_words_processed_with_features.csv",
            )
